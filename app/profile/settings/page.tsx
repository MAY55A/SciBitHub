    ...
    return (
        <Suspense fallback={<AccountSettingsSkeleton />}>
            <div className="flex flex-col gap-6">
                ...
                {user!.metadata?.researcherType === ResearcherType.ORGANIZATION && <OraganizationDetailsForm name={user?.metadata.organizationName || ""} location={user?.metadata.organizationLocation || ""} />}
