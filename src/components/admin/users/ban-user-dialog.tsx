...
export function BanUserDialog({ onConfirm }: { onConfirm: (durationFormatted: string) => void }) {
    ...
    return (
        <>
            <Button variant="ghost" size="sm" className="h-full hover:text-destructive pl-2" onClick={() => setOpen(true)}>
                Ban User
            </Button>
                ...
                <DialogContent>
                    ...
                    {!confirmed ? (
                        ...
                        <div className="space-y-4">
                            <p>Are you sure you want to ban this user for <strong>{formatDuration()}</strong>?</p>
                            <DialogFooter>
